...
class Student(models.Model):
    ...
    is_memorize_quran = models.BooleanField(default=False, blank=True, null=True)
    is_recite_all_quran = models.BooleanField(default=False, blank=True, null=True)
    date_to_recit_all_quran = models.DateTimeField(default=None, null=True)
    is_write_quran = models.BooleanField(default=False, blank=True, null=True)
    current_surate = models.CharField(max_length=50, default=None, blank=True, null=True)
    date_of_memorize_quran = models.DateTimeField(default=None, null=True)
    date_to_start_write_quran = models.DateTimeField(default=None, null=True)
    current_write_quran = models.CharField(max_length=50, default=None, blank=True, null=True)
    date_to_finish_write_quran = models.DateTimeField(default=None, null=True)
